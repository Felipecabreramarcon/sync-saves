...
export default function AddGameCard({ onPress }: { onPress: () => void }) {
    return (
        <Card
            onClick={onPress}
            className="group relative overflow-hidden border-2 border-dashed border-white/10 hover:border-primary-500/50 bg-transparent transition-all duration-300 min-h-[300px] flex items-center justify-center cursor-pointer"
            hover={false} // Disable default hover lift, allow custom behavior
        >
            ...
            <CardContent className="relative flex flex-col items-center justify-center gap-4 text-center py-12">
