            ...
            <GlassCard glass className="w-full max-w-md mx-4 relative z-10 border-white/10 shadow-2xl shadow-primary-900/20">
                <CardContent className="p-8 pt-8">
                    ...
                    >
                        ...
                        <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Sync Saves</h1>
                        <p className="text-content-secondary text-sm font-medium">Your game saves, everywhere.</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <Button
                            size="lg"
                            radius="lg"
                            className="w-full flex bg-white text-gray-900 font-bold h-14 hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-white/20 transition-all"
                            startContent={
                                <div className="p-1">
                        ...
                        <div className="flex items-center gap-4 py-2">
                            ...
                            <span className="text-content-tertiary text-[10px] font-bold tracking-widest uppercase">Or</span>
                            <Divider className="flex-1 bg-white/10" />
                        </div>
                        ...
                        <Button
                            size="lg"
                            className="w-full bg-bg-elevated/50 border border-white/10 text-white font-semibold h-14 hover:bg-white/5 hover:border-white/20 transition-all"
